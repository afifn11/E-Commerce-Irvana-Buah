            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-8 py-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-white">Edit Data Pengguna</h1>
                            <p class="text-white/80 text-sm">Perbarui informasi pengguna di bawah ini</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-gray-500">Diisi hanya jika mengubah password</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row justify-end items-center space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit"
                                ...
                                <span class="font-medium">Perbarui Data</span>
                            </button>
                        </div>
                    </form>
                </div>
