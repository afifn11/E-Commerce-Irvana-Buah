<nav x-data="{ open: false }" class="fixed w-full top-0 z-50 nav-glass">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-1 lg:ml-8">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="nav-link {{ request()->routeIs('products.*') ? 'nav-link-active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                        </svg>
                        Produk
                    </a>
                    <a href="{{ route('admin.categories.index') }}" class="nav-link {{ request()->routeIs('categories.*') ? 'nav-link-active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                        </svg>
                        Kategori
                    </a>
                    <a href="{{ route('admin.orders.index') }}" class="nav-link {{ request()->routeIs('orders.*') ? 'nav-link-active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                        </svg>
                        Pesanan
                    </a>
                    <a href="{{ route('admin.users.index') }}" class="nav-link {{ request()->routeIs('users.*') ? 'nav-link-active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                        Pengguna
                    </a>
                    <a href="{{ route('admin.coupons.index') }}" class="nav-link {{ request()->routeIs('admin.coupons.*') ? 'nav-link-active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                        </svg>
                        Kupon
                    </a>
                    <a href="{{ route('admin.reviews.index') }}" class="nav-link {{ request()->routeIs('admin.reviews.*') ? 'nav-link-active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <x-dropdown align="right" width="52">
                    ...
                    <x-slot name="content">
                        <div class="glass-dropdown">
                            ...
                            <x-dropdown-link :href="route('customer.profile')" class="glass-dropdown-item">
    ...
    <div x-show="open"
        ...
        <div style="padding:1rem;space-y:0.25rem;">
            ...
            <a href="{{ route('admin.products.index') }}" class="mobile-nav-link {{ request()->routeIs('products.*') ? 'mobile-nav-active' : '' }}">Produk</a>
            <a href="{{ route('admin.categories.index') }}" class="mobile-nav-link {{ request()->routeIs('categories.*') ? 'mobile-nav-active' : '' }}">Kategori</a>
            <a href="{{ route('admin.orders.index') }}" class="mobile-nav-link {{ request()->routeIs('orders.*') ? 'mobile-nav-active' : '' }}">Pesanan</a>
            <a href="{{ route('admin.users.index') }}" class="mobile-nav-link {{ request()->routeIs('users.*') ? 'mobile-nav-active' : '' }}">Pengguna</a>
            <a href="{{ route('admin.coupons.index') }}" class="mobile-nav-link {{ request()->routeIs('admin.coupons.*') ? 'mobile-nav-active' : '' }}">Kupon</a>
            <a href="{{ route('admin.reviews.index') }}" class="mobile-nav-link {{ request()->routeIs('admin.reviews.*') ? 'mobile-nav-active' : '' }}">Ulasan</a>
        </div>
        <div style="padding:0.75rem 1rem 1rem;border-top:1px solid var(--glass-border);">
            ...
            <a href="{{ route('customer.profile') }}" class="mobile-nav-link">Profile</a>
            <form method="POST" action="{{ route('logout') }}">
                @csrf
